  ...
  return (
   ...
   <div className='hidden sm:flex flex-col gap-4 items-center justify-center'>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 z-50 flex items-center justify-between w-full py-4 px-3 md:px-16 lg:px-24 xl:px-40">
                ...
                <div className="flex flex-col items-center justify-center max-w-80 px-6 py-4 bg-white  shadow-lg shadow-indigo-200 cursor-pointer rounded-lg hover:shadow-2xl hover:shadow-indigo-300 min-h-60">
                    ...
                    <div className="mt-5 space-y-2 text-center">
                        <h3 className="text-base font-semibold text-slate-700">AI-Powered Resume Assistant</h3>
                        <p className="text-sm text-slate-600">Create optimized resumes quickly with AI suggestions for better visibility to recruiters.</p>
                    </div>
                </div>
                <div className="flex flex-col items-center justify-center max-w-80 px-6 py-4 bg-white  shadow-lg shadow-indigo-200 cursor-pointer rounded-lg hover:shadow-2xl hover:shadow-indigo-300 min-h-60">
                    ...
                    <div className="mt-5 space-y-2 text-center ">
                        ...
                        <p className="text-sm text-slate-600">Use templates that pass automated screening systems effortlessly.</p>
                    </div>
                </div>
                <div className="flex flex-col items-center justify-center max-w-80 px-6 py-4 bg-white  shadow-lg shadow-indigo-200 cursor-pointer rounded-lg hover:shadow-2xl hover:shadow-indigo-300 min-h-60">
                    ...
                    <div className="mt-5 space-y-2 text-center">
                        <h3 className="text-base font-semibold text-slate-700">Multiple Role-Based Resumes</h3>
                        <p className="text-sm text-slate-600">Build and save different resumes in the database tailored for each job role.</p>
                    </div>
                </div>
            </div>
            </div>
