import { BriefcaseBusiness, Globe, Linkedin, LocationEdit, Mail, Phone, User } from 'lucide-react'
...
const handleChange = (field, value) => {
  ...
  return (
    ...
    <input type="file"  accept="image/jpeg,image/png"  className='hidden' id='imageUpload' onChange={(e)=>handleChange("image",e.target.files[0])} />
    </label>
